...
ssize_t razer_attr_write_side_mode_none(IOUSBDeviceInterface **usb_dev, const char *buf, size_t count, int side)
{
    ...
    switch(product) {
        ...
        case USB_DEVICE_ID_RAZER_BASILISK_V3_PRO_WIRED:
        case USB_DEVICE_ID_RAZER_BASILISK_V3_PRO_WIRELESS:
        case USB_DEVICE_ID_RAZER_COBRA_PRO_WIRED:     //see  https://github.com/openrazer/openrazer/blob/352d13c416f42e572016c02fd10a52fc9848644a/driver/razermouse_driver.c#L3165
        case USB_DEVICE_ID_RAZER_COBRA_PRO_WIRELESS:
